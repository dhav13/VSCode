...
//Little Ponny is given an array, A, of N integers. In a particular operation, he can set any element 
//of the array equal to -1.
...
namespace Scaler
{
    public class LittlePonnyMaximumElement : Base
    {

        static int MaxElement(int[] arr, int B)
        {
            int cnt = 0;
            bool f = false;
